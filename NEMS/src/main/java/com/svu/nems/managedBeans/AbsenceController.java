...
public class AbsenceController implements Serializable {
    ...
    @EJB
    private com.svu.nems.sessionBeans.AbsenceFacade ejbFacade;
    ...
    public Absence getAbsence(java.lang.Integer id) {
