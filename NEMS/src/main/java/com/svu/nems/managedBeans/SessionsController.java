...
import com.svu.nems.sessionBeans.SessionsFacade;
...
public class SessionsController implements Serializable {
    ...
    @EJB
    private com.svu.nems.sessionBeans.SessionsFacade ejbFacade;
    ...
    public Sessions getSessions(java.lang.Integer id) {
